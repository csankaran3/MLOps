...
if st.button("Predict"):
    ...
    result = "The customer is LIKELY to purchase the package" if prediction == 1 else "The customer is UNLIKELY to purchase the package"
    st.success(f"Tourism Package predictions completed!.. The prediction is {result}.")
